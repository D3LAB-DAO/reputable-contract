...
import "../interfaces/swap-core/IRepuSwapPair.sol";
import "./RepuSwapERC20.sol";
import "./libraries/math.sol";
import "./libraries/UQ112x112.sol";
import "../interfaces/swap-core/IRepuSwapFactory.sol";
import "../interfaces/swap-core/IRepuSwapCallee.sol";

contract RepuSwapPair is IRepuSwapPair, RepuSwapERC20 {
    ...
    modifier lock() {
        require(unlocked == 1, "RepuSwap: LOCKED");
        unlocked = 0;
        _;
        unlocked = 1;
    }
