...
contract Governor is GovernorStorage, GovernorEvents {
    ...
    uint256 public constant quorumVotes = 40000000e18; // 40,000,000 = 4% of REPU // TODO: veREPU
     ...
     * @param veRepu_ The address of the veREPU token
    ...
    constructor(
        ...
        require(
            veRepu_ != address(0),
            "Governor::initialize: invalid veRepu address"
        );

        timelock = ITimelock(address(new Timelock(7 days)));
        veRepu = IveREPU(veRepu_);
    ...
    function propose(
        ...
        require(
            veRepu.getPriorVotes(msg.sender, block.number - 1) >
                proposalThreshold,
    ...
    function cancel(uint256 proposalId) external {
        ...
        if (msg.sender != proposal.proposer) {
            require(
                (veRepu.getPriorVotes(proposal.proposer, block.number - 1) <
                    proposalThreshold),
    ...
    function castVoteInternal(
        ...
        uint96 votes = veRepu.getPriorVotes(voter, proposal.startBlock);
